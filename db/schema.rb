...
ActiveRecord::Schema.define(version: 2022_12_17_115310) do
  ...
  create_table "customers", force: :cascade do |t|
    ...
    t.string "postal_code", default: "", null: false
    t.string "adresses", default: "", null: false
  ...
  create_table "order_detailas", force: :cascade do |t|
    t.integer "item_id", null: false
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.string "delivery_adress", default: "", null: false
    t.string "delivery_name", default: "", null: false
